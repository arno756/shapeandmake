...
?>
        ...
        jQuery(function($) {
            ...
            $('.widget_wpbdp_zipsearchwidget input[type="submit"]').click(function(e) {
                ...
                var $distance = $( '.zipcode-search-distance-fields input', $form );
...
class WPBDP_ZIPCodeSearchModule {
    ...
    public function _register_settings( &$settingsapi ) {
        ...
        $settingsapi->add_setting( $s,
                                   'zipcode-field',
                                   _x( 'ZIP Code Field', 'settings', 'wpbdp-zipcodesearch' ),
                                   'choice',
                                   '',
                                   '',
        ...
        $settingsapi->add_setting( $s,
                                   ...
                                   _x( 'Use predefined radius options for proximity searches', 'settings', 'wpbdp-zipcodesearch' ),
                                   'boolean',
                                   false );
        $settingsapi->add_setting( $s,
        ...
        $settingsapi->add_setting( $s,
                                   'zipcode-force-order',
                                   _x( 'Sort listings by distance when showing results of proximity searches?', 'settings', 'wpbdp-zipcodesearch' ),
                                   'boolean',
                                   true );
    ...
    public function get_db_name( $dbid ) {
        ...
        return isset( $databases[ $dbid ] ) ? $databases[ $dbid ] : $dbid;
    }

    public function get_supported_databases() {
        $databases = array();
        $databases['us'] = _x( 'United States', 'databases', 'wpbdp-zipcodesearch' );
        $databases['uk'] = _x( 'United Kingdom (Great Britain)', 'databases', 'wpbdp-zipcodesearch' );
        $databases['au'] = _x( 'Australia', 'databases', 'wpbdp-zipcodesearch' );
        $databases['ca'] = _x( 'Canada', 'databases', 'wpbdp-zipcodesearch' );
        $databases['mx'] = _x( 'Mexico', 'databases', 'wpbdp-zipcodesearch' );
        $databases['de'] = _x( 'Germany', 'databases', 'wpbdp-zipcodesearch' );
